...
namespace STSdb4.General.Communication
{
    public class TcpServer
    {
        ...
        internal BlockingCollection<KeyValuePair<ServerConnection,Packet>> RecievedPackets;
        internal CancellationTokenSource ShutdownTokenSource { get; private set; }
        ...
        {
            foreach (KeyValuePair<ServerConnection, ServerConnection> connection in ServerConnections)
            {
