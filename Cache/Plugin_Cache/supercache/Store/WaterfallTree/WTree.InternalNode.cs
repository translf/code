...
namespace STSdb4.WaterfallTree
{
    ...
    {
        public int MIN_BRANCHES = 2;
        public int MAX_BRANCHES = 4;

        /// <summary>
        /// Minimum allowed number of all operations in all branches in an internal node.
        /// Recomended: MAX_OPERATIONS / 2
        /// </summary>
        public int MIN_OPERATIONS = 100000;//

        /// <summary>
        /// Maximum allowed number of all operations in all branches in an internal node.
        /// </summary>
        public int MAX_OPERATIONS = 100000;
        ...
        private sealed partial class InternalNode : Node
        {
            ...
            {
                get { return Branches.Count > Branch.Tree.MAX_BRANCHES; }
            }
            ...
            public override bool IsUnderflow
            {
                get
                {
                    ...
                    return Branches.Count < Branch.Tree.MIN_BRANCHES;
                }
            }
            ...
            /// The hook.
            /// </summary>
            public KeyValuePair<FullKey, Branch> FindBranch(ILocator locator, IData key, Direction direction, ref FullKey nearFullKey, ref bool hasNearFullKey)
            {
                Range range = Optimizator.FindRange(locator);
