...
namespace STSdb4.Data
{
    ...
    */
    ...
    public sealed class DataType : IEquatable<DataType> , IEnumerable<DataType>
    {
        ...
        public static readonly DataType UInt32 = new DataType(Code.Int32, null);
        ...
        {
            get { return code < Code.Slotes; }
        }

        public bool IsSlotes
        {
            get { return code == Code.Slotes; }
        }
        ...
        {
            get { return code == Code.KeyValuePair; }
        }
        ...
        public static DataType Slotes(params DataType[] slotes)
        {
            if (slotes.Length == 0)
                throw new ArgumentException("slotes.Length == 0");
            
            return new DataType(Code.Slotes, slotes);
        }
        ...
        public static DataType KeyValuePair(DataType TKey, DataType TValue)
        {
            return new DataType(Code.KeyValuePair, TKey, TValue );
        }
