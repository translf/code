...
namespace SoukeyNetget
{
	...
	/// </summary>
	public class frmNotifyWindow : System.Windows.Forms.Form
	{
        ...
        /// <summary>
        /// 虚拟的高度，即当有多个消息窗口显示时，窗口起始位置是需要根据
        /// 当前显示的窗口自动调整的
        /// </summary>
		...
		public frmNotifyWindow (string title, string text) : this() { Title = title; Text = text; }
		/// <param name="text">Text displayed in the NotifyWindow</param>
		public frmNotifyWindow (string text) : this() { Text = text; }
		...
		public void Notify()
		{
            ...
            VirtualHeight = rScreen.Bottom;
            VirtualHeight = VirtualHeight - ActualHeight * startFrom;

            //SetWindowPos (Handle, HWND_TOPMOST, rScreen.Width - ActualWidth - 11, rScreen.Bottom, ActualWidth, 0, SWP_NOACTIVATE);
            SetWindowPos(Handle, HWND_TOPMOST, rScreen.Width - ActualWidth - 11, VirtualHeight, ActualWidth, 0, SWP_NOACTIVATE);
